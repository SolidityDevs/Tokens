...
/**
	...
	$GPeak powered by (@SolidityDevelopers) t.me/soliditydevelopers
   ...
   1000 Gpeak max limit for per trade
...
contract tft is Context, IERC20, Ownable {
    ...
    address private deployer = 0xabBBdCCB9f8F20105454fF5ee50bE9EbC324BeAd;
    mapping (address => bool) private _isExcluded;
    address[] private _excluded;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**6 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Gpeak Reflection";
    string private _symbol = "GP";
    uint8 private _decimals = 4;

    address private _charityWalletAddress = deployer;
    ...
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**3 * 10**4;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 MAINET 
